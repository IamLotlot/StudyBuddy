...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2023 at 02:32 AM
...
INSERT INTO `account` (`userid`, `username`, `password`, `role`, `state`, `email`, `fullname`, `address`, `yearSection`, `age`, `studentid`, `sex`, `contact`, `profile`, `studFront`, `studBack`, `studycoin`, `subscriber`, `date`) VALUES
(1, 'admin', 'admin', 'admin', 'verified', 'admin@gmail.com', 'admin', 'admin house', 'BSIT 3B WAN', '21', '01201265', 'Male', '09087451933', 0x61646d696e5f50726f66696c652d506963747572652e6a7067, '', '', NULL, '', ''),
(2, 'user1', 'user1', 'user', 'verified', 'user1@gmail.com', 'carlos navea', 'user1 house', 'BSIT 3A WAM', '23', '01291290', 'Maalin', '09812382342', 0x75736572315f50726f66696c652d506963747572652e6a7067, '', '', 477, 'true', '10-03-23'),
(3, 'user2', 'user2', 'user', 'verified', 'user2@gmail.com', 'danielle zotomayor', 'user2 house', 'BSIT 3A WAM', '19', '01291232', 'Medyo baliko', '092831273621', 0x75736572325f50726f66696c652d506963747572652e6a7067, '', '', 1523, '', '');
...
(5, 2, 3, 716689, 'qweqweqwe', '19:27:22'),
(6, 2, 3, 716689, 'test', '19:27:43'),
(7, 2, 3, 716689, 'test', '19:29:40'),
(8, 2, 3, 716689, 'qwe', '19:29:50'),
(9, 2, 3, 716689, 'asdsadsa', '19:31:09'),
(10, 2, 3, 716689, 'asdsadsa', '19:31:48'),
(11, 2, 3, 716689, 'asdsadsa', '19:31:50'),
(12, 2, 3, 716689, 'estsets', '19:32:22');
...
('user2', 'Exploring Andruino', 'user1', '2023-11-14', '03:44:44'),
('user1', 'Computer Science Illuminated', 'user2', '2023-11-15', '05:46:01');
...
('Grobs Basic Electronics', 'user1', 'user2', '2023-11-15', '12:49:54');
...
(402167, 'carlos navea', 'danielle zotomayor', 'buddy'),
(402167, 'danielle zotomayor', 'carlos navea', 'buddy');
...
--
-- Dumping data for table `search_queue`
--

INSERT INTO `search_queue` (`queueId`, `fullname`, `course`, `category`, `sex`, `age`, `description`, `date`, `time`) VALUES
(56, 'danielle zotomayor', 'option2', 'option2', 'male', 11, 'test test', '2023-11-14', '20:55:04');
...
--
-- Dumping data for table `search_queue_con`
--

INSERT INTO `search_queue_con` (`matchId`, `fullname`, `course`, `category`, `sex`, `age`, `description`, `date`, `time`) VALUES
(156269, 'danielle zotomayor', 'option2', 'option2', 'male', '11', 'test test', '2023-11-14', '20:55:04'),
(156269, 'carlos navea', 'option2', 'option2', 'male', '11', 'none', '2023-11-15', '14:02:58');
...
--
ALTER TABLE `message_groups`
  MODIFY `groupid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=716690;
...
--
ALTER TABLE `search_queue`
  MODIFY `queueId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
